...
* I've worked on some open source tooling for Unity which can be viewed on the [initialPrefab Github](https://github.com/InitialPrefabs) including:
  * [C# TaskFlow](https://github.com/InitialPrefabs/InitialPrefabs.TaskFlow)
...
## Personal Projects
* I am currently working on a **Rust** & **Vulkan** based rendering engine, [Geometroid](https://github.com/psuong/geometroid).
